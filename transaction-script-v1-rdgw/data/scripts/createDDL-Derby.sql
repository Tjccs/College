...
CREATE TABLE CUSTOMER (ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY NOT NULL, DESIGNATION VARCHAR(50) NOT NULL, PHONENUMBER INTEGER, VATNUMBER INTEGER NOT NULL UNIQUE, DISCOUNT_ID INTEGER NOT NULL, ADRESS VARCHAR(255))
...
CREATE TABLE DEPARTMENT (ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1) NOT NULL, NAME VARCHAR(50) PRIMARY KEY, PHONE_NUMBER INTEGER)
CREATE TABLE EMPLOYEE (ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY NOT NULL, NAME VARCHAR(15), DESIGNATION VARCHAR(50), DEPARTMENT VARCHAR(50), FOREIGN KEY DEPARTMENT REFERENCES DEPARTMENT(NAME)) 
