...
public class Menu {
    ...
    /**
     * This method gives us the current day agenda for a given doctor
     * @param d, The doctor that we want the agenda from.
     * @throws IOException
     */
    ...
    /**
     * This method gives us tomorrow agenda for a given doctor
     * @param d, The doctor that we want the agenda from.
     * @throws IOException
     */
    ...
    /**
     * Creates a table with the agenda info.
     * @param d, The doctor that we want
     * @param day, The day that we want for the agenda.
     * @throws FileNotFoundException
     */
    private static void dayAgenda(Doctor d, Date day) throws FileNotFoundException {
    	//FIXME not working properly, the format of the printing it's not exactly what we want.
    ...
    /**
     * This method gives us week's agenda for a given doctor
     * @param d, The doctor that we want the agenda from.
     * @throws FileNotFoundException
     */
    private static void weekAgenda(Doctor doc) throws FileNotFoundException {
    	//TODO needs fixing to give the current week not the next 7 days.
    	Date tomorrow = Date.getCurrentDate().addMinutes(24 * 60);
        int i = 0;
        int x = 1440;
        while(i<7) {
