...
/**
 * Main application of the program, point of entry which launches the program.
 * @author fc48286
 * @author fc48760
 */
public class App {
	...
	*/
	...
	/**
	 * Gets the doctorCatalog and returns it to use in the main App
	 * @return doctorCatalog The Catalog of doctors
	 */
	...
	/**
	 * Gets the patientCatalog and returns it to use in the main App
	 * @return patientCatalog The Catalog with the patients
	 */
